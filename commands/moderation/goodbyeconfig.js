...
module.exports = {
    name: 'goodbyeconfig',
    description: 'Vous permet de configurer le système d\'aurevoir.',
            ...
            if (!data) {
                ...
                if (args[0].toLowerCase() === 'texte') {
                    ...
                    await message.channel.awaitMessages(messageFilter, { max: 1, time: 60000 }).then(async collected => {
                        ...
                        data.save();
                        message.channel.send(new Discord.MessageEmbed()
                            .setDescription(`<:icone_verified:824290381435895818> | ${message.author}, le texte d'aurevoir a bien été enregistré.`)
                            .setColor(`14b321`)
                        );
                    });
                    ...
                    const embed = new Discord.MessageEmbed()
                        .setTitle(`Tools Goodbye Config - Embed`)
                        .setDescription(`\n\n`)
                        .setColor(roleColor)
                    ...
                    collector.on('collect', async (reaction, user) => {
                        if (reaction.emoji.id === '824290384153673760') {
                            const MainEmbed = new Discord.MessageEmbed()
                                .setTitle(`Goodbye Config - Embed Maker`)
                                ...
                                .setColor(roleColor)
                                .setFooter('Tools Goodbye Config', client.user.avatarURL())
                                .setTimestamp()
                    ...
                    const embed = new Discord.MessageEmbed()
                        .setTitle(`Tools Goodbye Config - Image`)
                        .setDescription(`\n\n`)
                        .setColor(roleColor)
                        .setDescription(`Appuyez sur les réactions pour valider votre choix.`)
                        .setFooter(`Demandé par ${message.author.username} !`, client.user.displayAvatarURL({ format: 'png', dynamic: true }))
